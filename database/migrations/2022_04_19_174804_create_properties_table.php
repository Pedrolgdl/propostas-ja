...
class CreatePropertiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('properties', function (Blueprint $table) {
            ...
            $table->float('price', 8, 2);        //valor do imóvel
            $table->float('iptu', 8, 2);         //valor do IPTU
            ...
            $table->float('condominium', 8, 2)->nullable(true);     //não obrigatório
            $table->text('condominium_description')->nullable(true);  //não obrigatório
            $table->float('fire_insurance', 8, 2)->nullable(true);  //não obrigatório
            $table->float('service_charge', 8, 2)->nullable(true);  //não obrigatório
            $table->string('state');
            $table->string('cep');
            $table->string('city');
