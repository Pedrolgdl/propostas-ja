...
class UserController extends Controller
{
    ...
    {
        $users = DB::select('SELECT DISTINCT u.user_photo, u.name, u.surname, COUNT(*) FROM users AS u INNER JOIN properties AS p ON u.id = p.user_id GROUP BY u.user_photo, u.name, u.surname ORDER BY u.name');
